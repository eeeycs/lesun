...
<body>
<form action="action/return_goods_money.php" method="post" name="return_goods_money">
  <table  style='white-space: nowrap;'  border="0" cellspacing="0">
    <caption class="caption_bigtitle">
      退货退款单录入系统
    </caption>
    <tr>
      <td><font color="#FF0000" size="+1">*</font>退货退款单号</td>
      <td><input name="return_goods_money_odd_number" type="text" required="required" id="return_goods_money_odd_number"></td>
    </tr>
    <tr>
...
?></td>
    ...
    <tr>
      <td>备注</td>
      <td><input type="text" name="memo" id="memo" value="退货退款"></td>
    </tr>
    <tr>
      <td width="108">&nbsp;</td>
      <td width="544"><input type="submit" name="submit" id="submit" value="提交"></td>
    </tr>
  </table>
